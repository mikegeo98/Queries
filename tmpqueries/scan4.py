...
spark = SparkSession.builder.appName("test_DFAPI").config("spark.executor.instances","1").config("spark.executor.cores","1").master("yarn").getOrCreate()
