...
spark = SparkSession.builder.appName("Query3_DFAPI").config("spark.executor.instances","7").config("spark.executor.cores","4").master("yarn").config("spark.sql.warehouse.dir", warehouse_location).enableHiveSupport().getOrCreate()
